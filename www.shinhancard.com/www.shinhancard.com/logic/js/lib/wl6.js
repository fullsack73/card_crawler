...
function n_SetCookie(name, value)
{
	...
	document.cookie =
		name + "=" + escape (value.replace("\r", "").replace("\n", ""))
...
function n_Logging_UCID() {
	if ( (typeof _n_ucid)!="undefined" && _n_ucid ) { n_setCustomParam("_n_ucid", _n_ucid); }
}
